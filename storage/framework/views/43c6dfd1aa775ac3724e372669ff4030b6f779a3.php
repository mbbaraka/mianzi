                ...
                <div class="col-md-12">
                    <div class="tile">
                        <div class="">
                            <h3>
                                Edit User Details
                                <a href="<?php echo e(route('users.index')); ?>" class="btn btn-primary float-right btn-sm">Back</a>
                            </h3>
                        </div>
                        <div class="tile-body">
...
unset($__errorArgs, $__bag); ?>" name="mobile" value="<?php echo e($user->mobile); ?>" placeholder="10 digit Mobile number" minlength=10 maxlength=10 pattern="\d*" title="10 digit Mobile number" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select id="select2" class="form-control <?php $__errorArgs = ['roles'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="roles[]" multiple required>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                        <label id="roles-error" class="error" for="roles"><?php echo e($message); ?></label>
                                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<script type="text/javascript">
    var test = "<?php echo e($selectedRoles); ?>";
    if (test != '') {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mianzi\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>