<header class="app-header">
      <a class="app-header__logo" target="_blank" href="<?php echo e(url('/')); ?>"><?php echo e(config('app.name')); ?></a>
      <!-- Sidebar toggle button--><a
        class="app-sidebar__toggle fa fa-bars"
        href="#"
        data-toggle="sidebar"
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown">
          ...
          ><sup class="badge rounded bg-danger">2</sup></a>
            ...
            <li>
              <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                onclick="event.preventDefault();
                              document.getElementById('logout-form').submit();"><i class="far fa-sign-in fa-lg"></i> Logout</a
              >
    ...
    </header><?php /**PATH C:\xampp\htdocs\mianzi\resources\views/layouts/partials/admin/nav.blade.php ENDPATH**/ ?>