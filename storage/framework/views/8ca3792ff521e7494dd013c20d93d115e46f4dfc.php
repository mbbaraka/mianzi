...
} elseif ($_instance->childHasBeenRendered('MGLVNIu')) {
    $componentId = $_instance->getRenderedChildComponentId('MGLVNIu');
    $componentTag = $_instance->getRenderedChildComponentTagName('MGLVNIu');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MGLVNIu');
} else {
    $response = \Livewire\Livewire::mount('search');
    $dom = $response->dom;
    $_instance->logRenderedChild('MGLVNIu', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                        </div>
         ...
         </header><?php /**PATH C:\xampp\htdocs\mianzi\resources\views/layouts/partials/home/mobile-header.blade.php ENDPATH**/ ?>