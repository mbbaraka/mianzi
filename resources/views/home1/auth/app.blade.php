...
<head>
    ...
    <link rel="icon" href="{{ asset('frontend/images/favicon/favicon.ico') }}" type="image/x-icon">
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/color2.css') }}" media="screen" id="color">
</head>
<body>
            ...
            <div class="col-md-12">
                <div class="main-menu-block">
                    ...
                    <div class="logo-block">
                        <a href="index.html"><img src="{{ asset('frontend/images/layout-2/logo/logo.png') }}" class="img-fluid  " alt="logo"></a>
                    </div>
                                ...
                                <div class="nav-left" >
                                    ...
                                    <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                        <ul class="nav-cat title-font">
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/01.png') }}" alt="category-product"> <a href="#">western ware</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/02.png') }}" alt="category-product"> <a href="#">TV, Appliances</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/03.png') }}" alt="category-product"> <a href="#">Pets Products</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/04.png') }}" alt="category-product"> <a href="#">Car, Motorbike</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/05.png') }}" alt="category-product"> <a href="#">Industrial Products</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/06.png') }}" alt="category-product"> <a href="#">Beauty, Health Products</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/07.png') }}" alt="category-product"> <a href="#">Grocery Products </a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/08.png') }}" alt="category-product"> <a href="#">Sports</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/09.png') }}" alt="category-product"> <a href="#">Bags, Luggage</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/10.png') }}" alt="category-product"> <a href="#">Movies, Music </a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/11.png') }}" alt="category-product"> <a href="#">Video Games</a></li>
                                            <li> <img src="{{ asset('frontend/images/layout-1/nav-img/12.png') }}" alt="category-product"> <a href="#">Toys, Baby Products</a></li>
                                            <li>
                                                <ul class="mor-slide-open">
                                                    <li> <img src="{{ asset('frontend/images/layout-1/nav-img/08.png') }}" alt="category-product"> <a>Sports</a></li>
                                                    <li> <img src="{{ asset('frontend/images/layout-1/nav-img/09.png') }}" alt="category-product"> <a>Bags, Luggage</a></li>
                                                    <li> <img src="{{ asset('frontend/images/layout-1/nav-img/10.png') }}" alt="category-product"> <a>Movies, Music </a></li>
                                                    <li> <img src="{{ asset('frontend/images/layout-1/nav-img/11.png') }}" alt="category-product"> <a>Video Games</a></li>
                                                    <li> <img src="{{ asset('frontend/images/layout-1/nav-img/12.png') }}" alt="category-product"> <a>Toys, Baby Products</a></li>
                                                </ul>
                                            </li>
                                            <li>
                        ...
                        <div class="category-right">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu gift-dropdown">
                                    ...
                                    <div class="media">
                                        <div  class="mr-3">
                                            <img src="{{ asset('frontend/images/icon/2.png') }}" alt="Generic placeholder image" class="gift-bloc">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Fashion Discount</h5>
                                            <p><img src="{{ asset('frontend/images/icon/fire.png') }}"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div  class="mr-3">
                        ...
                        <div class="col-lg-4 col-md-12 pr-lg-0">
                            <div class="footer-left">
                                <div class="footer-logo">
                                    <img src="{{ asset('frontend/images/layout-2/logo/logo.png') }}" class="img-fluid  " alt="logo">
                                </div>
                                <div class="footer-detail">
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock,</p>
                                    <ul class="paymant-bottom">
                                        <li><a href="#"><img src="{{ asset('frontend/images/layout-1/pay/1.png') }}" class="img-fluid" alt="pay"></a></li>
                                        <li><a href="#"><img src="{{ asset('frontend/images/layout-1/pay/2.png') }}" class="img-fluid" alt="pay"></a></li>
                                        <li><a href="#"><img src="{{ asset('frontend/images/layout-1/pay/3.png') }}" class="img-fluid" alt="pay"></a></li>
                                        <li><a href="#"><img src="{{ asset('frontend/images/layout-1/pay/4.png') }}" class="img-fluid" alt="pay"></a></li>
                                        <li><a href="#"><img src="{{ asset('frontend/images/layout-1/pay/5.png') }}" class="img-fluid" alt="pay"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="app-link-bloc-contain app-link-bloc-contain-1">
                    <div class="app-item-group">
                        <div class="app-item">
                            <img src="{{ asset('frontend/images/layout-1/app/1.png') }}" class="img-fluid" alt="app-banner">
                        </div>
                        <div class="app-item">
                            <img src="{{ asset('frontend/images/layout-1/app/2.png') }}" class="img-fluid" alt="app-banner">
                        </div>
                    </div>
                    <div class="app-item-group ">
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="{{ asset('frontend/images/layout-4/product/1.jpg') }}">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="{{ asset('frontend/images/layout-4/product/2.jpg') }}">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="mr-3" src="{{ asset('frontend/images/layout-4/product/3.jpg') }}"></a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                            </a>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="{{ asset('frontend/images/layout-1/media-banner/1.jpg') }}">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="{{ asset('frontend/images/layout-1/media-banner/2.jpg') }}">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="mr-3" src="{{ asset('frontend/images/layout-1/media-banner/3.jpg') }}"></a>
                        <div class="media-body">
