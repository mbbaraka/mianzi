...
<div class="products-list__item">
    <div class="product-card">
       ...
       <div class="product-card__image"><a href="{{ url($product->slug.'.html') }}"><img style="width: 228.5px; max-height: 228.5px;" src="{{ asset('app/product/'.$product->cover) }}" alt="{{ $product->title }}"></a></div>
