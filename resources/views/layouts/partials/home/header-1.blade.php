                                    ...
                                    <div class="dropcart">
                                       <div class="dropcart__products-list">
                                          ...
                                          <div class="dropcart__product">
                                             <div class="dropcart__product-image"><a href="product.html"><img style="width: 70px; height: 70px;" src="{{ asset('app/product/'.$carts->product->cover) }}" alt="{{$carts->product->title}}"></a>
                                             </div>
