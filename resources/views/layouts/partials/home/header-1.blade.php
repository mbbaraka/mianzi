                                    ...
                                    <div class="dropcart">
                                       <div class="dropcart__products-list">
                                          ...
                                          <div class="dropcart__product">
                                             <div class="dropcart__product-image"><a href="product.html"><img style="width: 70px; height: 70px;" src="{{ asset('storage/product/'.$carts->product->cover) }}" alt="{{$carts->product->title}}"></a>
                                             </div>
                                    ...
                                    <div class="dropcart">
                                       <div class="dropcart__products-list">
                                          ...
                                          <div class="dropcart__product">
                                             ...
                                             <a href="{{ route('cart.destroy', $carts->__raw_id) }}" class="dropcart__product-remove btn btn-light btn-sm">
                                                <i style="width: 10px; height: 10px;" class="fa fa-times"></i>
                                             </a>
                                          </div>
                                          @endforeach
